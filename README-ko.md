...
- 구글 머티리얼 디자인을 참고하여 앱을 디자인했습니다. 그리고 100% 코틀린 언어로 앱을 개발했습니다.

- 현재의 자원 봉사 웹 페이지와는 달리, 파이썬의 Word2Vec 모듈에서 단어 임베딩 기법을 통한 단어 간의 유사성을 확보하여, 검색 서비스를 실행할 때 누락된 결과가 발생하지 않도록 구현하였습니다.

- 필터링 알고리즘을 통해 개별 사용자에게 맞춤형 서비스 활동 정보를 제공하고자 하였습니다.
- Retrofit2 라이브러리를 사용하여 Django 서버와 양방향으로 데이터를 통신할 수 있습니다.
- Vue.js 를 통한 관리자 웹 페이지를 제작 중입니다. 
